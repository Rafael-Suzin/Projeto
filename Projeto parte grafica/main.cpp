...
public:
    MatrixSolver(QWidget *parent = nullptr) : QWidget(parent) {
        ...
        connect(lineEditL, &QLineEdit::textChanged, this, &MatrixSolver::updateMatrixSize);
        connect(lineEditC, &QLineEdit::textChanged, this, &MatrixSolver::updateMatrixSize);
        ...
        connect(okButton, &QPushButton::clicked, this, &MatrixSolver::handleOKButtonClick);
...
private slots:
    void updateMatrixSize() {
        ...
        initialize();
        updateFrames(); // Atualiza os frames com os novos dados
    }

    void handleOKButtonClick() {
        // Implemente a lógica para processar os dados quando o botão OK for clicado
...
int main(int argc, char *argv[]) {
    ...
    MatrixSolver solver;
    solver.setGeometry(0, 0, 400, 200);
    solver.show();
